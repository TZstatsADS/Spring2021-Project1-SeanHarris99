...
#ggsave(paste("../figs/",names(fit$model)[2],".png"))
...
<br>The regression suggests a 1-percentile increase in wealth correlates with a .36% increase of Republican vote and a .33% decrease in abstaining from voting. 
...
ggplotRegression(lm(anes_income_rep_rich$prop~seq(2000, 2016, by=4)))+ labs(title="",y="Proportion of Republicans",x="Year")
...
<br> We can do a linear regression analysis to see if higher-salary occupations are becoming less Republican.
...
<br>The regression suggests Professional and Managerial voters have grown increasingly Democratic since the 70s. 
